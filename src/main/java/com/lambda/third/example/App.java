...
public class App {
    ...
    public static void main(String[] args) {
        ...
        studentInfo.testStudents(students, st -> st.getAvgGrade() > 8.0);
        System.out.println(LINE);
        studentInfo.testStudents(students, st -> st.getAvgGrade() < 8.0);
        System.out.println(LINE);
        studentInfo.testStudents(students, st -> st.getAge() > 25);
        System.out.println(LINE);
        studentInfo.testStudents(students, st -> st.getAge() < 25);
        System.out.println(LINE);
        studentInfo.testStudents(students, st -> st.getAvgGrade() > 8.5 && st.getSex() == 'm');
    }
}
